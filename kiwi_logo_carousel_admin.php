			...
			<?php
				...
				if ( $this->find_parameters($carousel) == false ){ die('Kiwi cannot write or read in the database.'); }
					...
					if (isset($_POST['submit'])) {
						...
						$parameters['autoControls'] = $this->rdie($_POST['klc_autocontrols'], $default['autoControls']);
										...
										<div class="inside">
											<table class="form-table">
												...
												<tr valign="top">
													...
													<td><input name="klc_slideheight" type="number" value="<?php if (isset($p['klco_height'])) {echo $p['klco_height'];} ?>"/></td>
												</tr>
											</table>
										</div>
									</div>
